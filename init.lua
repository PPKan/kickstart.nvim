...
-- [[ Basic Keymaps ]]
require('custom.basics.keymap').setup()

-- [[ Basic Settings ]]
require('custom.basics.set').setup()
...

  {
    ...
    config = function()
      require('im_select').setup {
        ...
        default_comman = 'C:\\tools\\im-select.exe',
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, go = false }
